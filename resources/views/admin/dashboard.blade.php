        ...
        <div class="md:flex md:max-w-[1200px] flex-col w-full ml-2 mr-2">
            ...
            <div class="rounded-md gap-2 grid grid-cols-2 md:grid-cols-4">
                ...
                <div class="bg-white h-36 rounded-xl shadow-sm text-center py-2">
                    ...
                    <div class="mt-4 flex justify-center">
                        <svg class="h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M461.2 128H80c-8.8 0-16-7.2-16-16s7.2-16 16-16h384c8.8 0 16-7.2 16-16 0-26.5-21.5-48-48-48H64C28.7 32 0 60.7 0 96v320c0 35.4 28.7 64 64 64h397.2c28 0 50.8-21.5 50.8-48V176c0-26.5-22.8-48-50.8-48zM416 336c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32z"/></svg>
                    </div>
                    <div class="mt-3 text-2xl font-semibold">
                        R$ 20.235,00
                    </div>
                ...
                <div class="md:w-[95%]">
                    <div class="flex flex-col gap mb-2 px-2">
                        <div class="flex gap-2 items-center">
                            ...
                            <span class="font-semibold">Último chamados</span>
                        </div>
                    ...
                    <div class="bg-white mt-4 rounded-xl h-[400px] p-2 gap-2 flex flex-col">
