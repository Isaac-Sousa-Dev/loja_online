                        ...
                        <div>
                            ...
                            <div class="p-2 flex flex-col space-y-2" >
                                @if (Auth::user()->role == 'partner')
                                    ...
                                    @php
                                        $productsRoute = in_array('products', $modules)
                                            ? route('products.index')
                                            : route('upgrade.index');
                                    @endphp
                                    <x-nav-link :href="$productsRoute" :active="(request()->routeIs('products.index') || request()->routeIs('products.create') || request()->routeIs('products.edit'))">
