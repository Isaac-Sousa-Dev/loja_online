<div class="sidebarMenu z-40 w-[250px] overflow-auto bg-[#33363B] text-white border-r border-[#6A2BBA]/20">

     <!-- Botão de fechar (visível apenas no mobile) -->
     <div class="flex justify-end p-2 cursor-pointer">
        <button id="closeSidebarMenu">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 font-bold" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
            </svg>
        </button>
    </div>

    <div class="flex flex-col bg-[#33363B] gap-2 mt-0 items-center h-32 justify-center">
                    ...
                    <div>
                        ...
                        <div class="p-2 flex flex-col space-y-2" >
                            ...
                            <x-nav-link :href="route('index.analytics')" :active="request()->routeIs('index.analytics')">
                                ...
                                {{ __('Analytics') }}
                                <span class="text-xs font-bold bg-[#FF914D] text-[#33363B] px-1.5 py-0.5 rounded-md">Em breve</span>
                            </x-nav-link>
    ...
    <script>
        let closeSidebarMenu = document.getElementById('closeSidebarMenu');
        let sidebarInNavigation = document.querySelector('#sidebar');

        $(closeSidebarMenu).click(function (e) { 
            e.preventDefault();
            let sidebar = $('#sidebar');
            sidebar.toggleClass('translate-x-[-100%]');
            sidebar.removeClass('w-[65%]');
