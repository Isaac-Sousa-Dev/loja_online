            ...
            <div class="section-right">
                ...
                <div class="card-send-desktop bg-white shadow-md p-4 rounded-xl">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" id="inputModalPdpNameDesktop" placeholder="Seu nome" class="w-full border border-gray-300 rounded-lg p-2 mt-1">
                    ...
                    <div class="mt-4">
                        ...
                        <input id="inputModalPdpPhoneDesktop" type="text" placeholder="Seu telefone" class="phone-mask w-full border border-gray-300 rounded-lg p-2 mt-1">
...
Olá, tenho interesse no veículo {{$product->name}}. Gostaria de receber mais informações sobre o veículo. Poderia entrar em contato?
                    ...
                    <div class="mt-4">
                        <button id="btnSendSolicitationPdpDesktop" class="bg-blue-700 text-white font-bold px-4 py-2 rounded-lg w-full">Enviar</button>
                    </div>
                </div>
            </div>
        </div>
...
<style>
    ...
    /* Section Left (com scroll) */
    .section-left {
        height: calc(100vh - 50px); /* Altura da viewport menos cabeçalho e rodapé */
    ...
    .section-right {
        ...
        position: sticky;
        top: 80px; /* Distância do topo (altura do cabeçalho) */
        height: calc(100vh - 160px); /* Altura da viewport menos cabeçalho e rodapé */
        padding: 20px;
