        ...
        <div class="py-2 px-2 flex justify-center pb-24 md:pb-0">
            ...
            <div class="flex flex-col w-full max-w-[900px]">
                ...
                <nav class="flex items-center gap-1.5 text-sm text-gray-500 mt-4 mb-1 px-1" aria-label="breadcrumb">
                    ...
                    <i class="fa-solid fa-chevron-right text-[10px] text-gray-400"></i>
                    <span class="font-semibold text-gray-700">Nova Categoria</span>
                </nav>
                        ...
                        <div class="rounded-xl shadow-md pt-3 pb-2 mb-4 flex flex-col bg-white px-3">
                            ...
                            <div>
                                <div class="w-full mb-3">
                                    ...
                                    <x-text-input id="name-category" class="required" placeholder="Camisetas, Jeans..."
                                        name="name-category" type="text" autofocus autocomplete="name" />
                            ...
                            <div class="md:flex mb-0">
                                <div class="w-full mb-3">
                                    ...
                                    <x-textarea id="description-category" class="required" placeholder="Descreva algo..."
                                        name="description-category" type="text" autofocus
                                        autocomplete="name"></x-textarea>
                ...
                <div
                    ...
                    <div class="flex w-full md:w-[280px] justify-between gap-3 md:py-1 md:px-3 bg-white rounded-xl">
                        ...
                        <x-primary-button id="btnSaveDataCategory"
