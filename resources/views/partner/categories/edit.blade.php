        ...
        <div class="w-full max-w-[900px] mt-4">
                    ...
                    <div class="rounded-xl shadow-md pt-3 pb-2 mb-4 flex flex-col bg-white px-3">
                        ...
                        <div>
                            <div class="w-full mb-3">
                                ...
                                <x-text-input id="name-category-update" class="required" placeholder="Carro, Moto..." value="{{$storeCategory->category->name}}" name="name-category-update" type="text" autofocus autocomplete="name" />
                        ...
                        <div class="md:flex mb-0">
                            <div class="w-full mb-3">
                                ...
                                <x-textarea id="description-category-update" class="required" placeholder="Descreva algo..." name="description-category-update" type="text" autofocus autocomplete="name" >
            ...
            <div class="w-full justify-end flex mb-4 gap-2">
                <div class="flex w-full md:w-2/6 justify-between gap-3 py-2 px-3 bg-white rounded-xl">
                    ...
                    <x-primary-button id="btnUpdateDataCategory">{{ __('Salvar') }}</x-primary-button>
                </div>
            </div>
        </div>
    </div>
