                ...
                <form action="{{ route('members.store') }}" method="POST">
                    ...
                    <div class="rounded-xl shadow-md pt-3 pb-2 mb-3 flex flex-col bg-white px-3">
                        ...
                        <div class="flex flex-col md:flex-row md:gap-4">
                            <div class="w-full mb-3">
                                ...
                                <x-text-input id="name" class="required" placeholder="Nome do membro" name="name" type="text" autofocus autocomplete="name" />
                            </div>

                            <div class="w-full mb-3">
                                <x-input-label for="email" :value="__('E-mail *')" />
                                <x-text-input id="email" class="required" placeholder="E-mail" name="email" type="text" />
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row md:gap-4">
                            ...
                            <div class="w-full mb-3">
                                ...
                                <x-text-input id="phone" class="required phone-mask" placeholder="Telefone" name="phone" type="text" />
                            </div>
                        </div>
                    ...
                    <div class="w-full justify-end flex mb-4 gap-2">
                        <div class="flex w-full md:w-2/6 justify-between gap-3 py-2 px-3 bg-white rounded-xl">
                            ...
                            <x-primary-button id="btnSaveDataMember">{{ __('Salvar') }}</x-primary-button>
                        </div>
                    </div>
...
<script>
    ...
    $('#btnSaveDataMember').click(function(e) {
        e.preventDefault();
