                    ...
                    <div class="rounded-xl shadow-md pt-3 pb-2 mb-4 flex flex-col bg-white px-3">
                                ...
                                <div class="w-full ">
                                    <select id="brand_id" class="select-brands border-gray-300 focus:border-indigo-300 focus:ring-indigo-300 rounded-xl shadow-xs block w-full">        
                                        @foreach($brandsByPartner as $brandByPartner)
                                            <option value="{{$brandByPartner->id}}">{{$brandByPartner->name}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="md:flex mb-3">
                            <div class="w-full">
                                ...
                                <x-text-input id="name" placeholder="Posche Cayenne" name="name" type="text" />
                        ...
                        <div class="md:flex mb-0">
                            <div class="w-full mb-3">
                                ...
                                <x-textarea id="description" class="required" placeholder="Descreva algo..." name="description" type="text" autofocus autocomplete="name" ></x-textarea>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-2 gap-1 md:w-1/2">
                                <label for="" class="w-full">
                                    <div class="OpenModalImagesProducts relative bg-blue-50 w-full h-32 cursor-pointer rounded-lg border-dashed border-2 border-sky-500 flex flex-col px-0">
                                        ...
                                        <img src="" style="display: none" class="previewsImagesInProductPage object-cover h-full w-full absolute rounded-lg" alt="">
                                    </div>
                                </label>
                                ...
                                <label for="" class="w-full">
                                    <div class="OpenModalImagesProducts relative bg-blue-50 w-full h-32 cursor-pointer rounded-lg border-dashed border-2 border-sky-500 flex flex-col justify-center items-center">
                                        ...
                                        <img src="" style="display: none" alt="" class="previewsImagesInProductPage object-cover h-full w-full absolute rounded-lg">
                                    </div>
                                </label>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-1 md:w-1/2">
                                ...
                                <label for="" class="w-full">
                                    <div class="OpenModalImagesProducts relative opacity-85 bg-blue-50 w-full h-32 cursor-pointer rounded-lg border-dashed border-2 border-sky-500 flex flex-col justify-center items-center">
                                        ...
                                        <img src="" id="previewSecondImage" style="display: none" alt="" class="previewsImagesInProductPage object-cover h-full w-full absolute opacity-50 rounded-lg">
                                    </div>
                                </label>
                            </div>
                        ...
                        <div class="flex flex-col gap-2">
                            <div class="w-full flex gap-2">
                                <div class="w-1/2">
                                    ...
                                    <x-text-input id="price" placeholder="R$ 0.00" name="price" type="text" class="price-mask required" />
                                </div>

                                <div class="w-1/2">
                                    <x-input-label for="price_promotional" :value="__('Preço promocional')" />
                                    <x-text-input id="price_promotional" placeholder="R$ 0.00" name="price_promotional" type="text" class="price-mask"  autofocus autocomplete="name" />
                            ...
                            <div class="w-full flex gap-2">
                                <div class="w-1/2">
                                    ...
                                    <x-text-input id="cost" placeholder="R$ 0.00" name="cost" type="text" class="price-mask"  autofocus autocomplete="name" />
                                    {{-- <x-input-error class="mt-2" :messages="$errors->get('cost')" /> --}}
                                </div>

                                <div class="w-1/2">
                                    <x-input-label for="profit" :value="__('Margem de lucro')" />
                                    <x-text-input disabled id="profit" placeholder="--" name="profit" type="text" class="bg-gray-200"  autofocus autocomplete="name" />
                        ...
                        <div class="flex flex-col gap-3">
                            <div class="w-full">
                                ...
                                <select id="type" placeholder="Não" name="type" type="text" class="border-gray-300 pt-1.5 focus:border-indigo-300 focus:ring-indigo-300 rounded-md h-9 shadow-xs w-full">
                                    <option value="owner">Próprio</option>
                                    <option value="consigned">Consignado</option>
                                </select>
                                <x-input-error class="mt-2" :messages="$errors->get('type')" />
                            </div>
    
                            <x-file-upload label="CRLV" name="crlv" />
                            <x-file-upload label="DUT" name="dut" />
                            <x-file-upload label="Nota fiscal de compra" name="purchase_invoice" />

                            {{-- Edit --}}
                            {{-- <x-file-upload label="CRLV" name="crlv" :file-url="$member->crlv_url" /> --}}
    ...
    const sortable = new Sortable(previewImages, {
        ...
        onSort: function () {
            ...
            $('#previewImages > div').each(function (e, index) {
                ...
                const imageName = $(this).data('name'); // Pegue o nome da imagem do atributo `data-name`
                const imageData = imagesArray.find(image => image.name === imageName); // Encontre a imagem correspondente no array
                if (imageData) {
