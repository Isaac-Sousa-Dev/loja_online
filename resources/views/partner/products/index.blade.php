<x-app-layout>
                ...
                <div class="flex flex-col md:justify-between mt-4">
                    ...
                    <div class="flex flex-wrap md:items-center mt-3 gap-2">
                        ...
                        <div class="w-full flex items-center gap-1 justify-between">
                            {{-- <x-text-input id="inputSearchProduct" type="text" class="block w-2/4" placeholder="Pesquisar por nome..." /> --}}
                            <div></div>
                            {{-- <button class="flex" href="javascript:void(0)">
                                <a href="{{ route('products.create') }}"
                                    class="inline-flex md:items-center gap-1 md:gap-2 px-4 py-[11px] md:px-2 md:py-[8px] border border-transparent text-sm leading-5 font-medium rounded-xl text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-blue active:bg-blue-700 transition ease-in-out duration-150">
                        ...
                        <div class="w-full flex justify-between items-center mt-2">
                            ...
                            <div class="flex items-center gap-1 md:gap-2">
                                {{-- <button class="bg-green-500 hover:bg-green-400 py-[13px] md:px-2 md:py-2 px-3 justify-center items-center gap-2 rounded-xl flex font-medium text-white">
                                    <svg class="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 14v4.833A1.166 1.166 0 0 1 16.833 20H5.167A1.167 1.167 0 0 1 4 18.833V7.167A1.166 1.166 0 0 1 5.167 6h4.618m4.447-2H20v5.768m-7.889 2.121 7.778-7.778"/>
                                      </svg>                              
                                    <span class="hidden md:block text-sm">Exportar</span>
                                </button>
    
                                <button class="bg-sky-500 hover:bg-sky-400 py-[13px] md:px-2 md:py-2 px-3 justify-center items-center rounded-xl gap-2 flex font-medium text-white">
                                    <svg class="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    ...
                                    <span class="hidden md:block text-sm">Importar</span>
                    ...
                    <div class="overflow-auto  md:overflow-hidden rounded-lg border border-gray-200 shadow-sm mt-3">
                        ...
                        <div class="hidden md:block">
                            <div class="px-2 py-1 bg-gray-50 shadow-sm flex gap-3">
                                ...
                                <div class="font-semibold w-[13%]">
                                    Preço
                                </div>

                                <div class="font-semibold w-[28%] px-1">
                                    Promocional
                                </div>
    ...
    <div id="deleteConfirmationModalProduct" class="hidden fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title"
